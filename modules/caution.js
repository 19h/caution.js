(function (global) {
	...
	var jsSeedCaution = "define._c={_m:{},fail:function(e,n){var r=\"Missing safe module: \"+e+\"\\n\"+n.join(\"\\n\");throw alert(r),new Error(r)}};var init=function(e){function n(e,n,t){function a(f){if(i.length){var o=new XMLHttpRequest,s=i.shift();o.open(\"GET\",s),o.onreadystatechange=function(){if(o.readyState>3){var n=o.status/100^2,i=o.responseText.replace(/\\r/g,\"\"),f=n||sha256(encodeURI(i).replace(/%(..)/g,function(e,n){return String.fromCharCode(\"0x\"+n-0)})),c='/.test(\"'+f+'\")';!n&&eval(\"/^\"+t.join(c+\"|/^\")+c)?(r._m[define._n=e]=[s,f],Function(i)(),define._n=\"\"):a(1)}};try{o.send()}catch(c){a(c)}}else r.fail(e,n,f)}n=n||[],t=t||n;var i=r.urls(e,n);r._m[e]||(r._m[e]=[],a())}init=0;var r=define._c;define.urls=function(n,r){function t(e){var a=[],i=/\\{v\\}/g;if(e+\"\"!==e)e[n]&&(a=t(e[n]));else if(e=e.replace(/\\{m?\\}/g,n),i.test(e))for(var f=0;r&&r[f];f++)a.push(e.replace(i,r[f]));else a[0]=e;return a}return[].concat.apply([],e.u.map(t))};for(var t in e.m){var a=e.m[t];n(t,a.v,a.s)}};";
