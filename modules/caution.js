(function (global) {
	...
	var inlineJs = "var sha256=function n(r){function t(n,r){return n>>>r|n<<32-r}for(var e,o,f=Math.pow,i=f(2,32),a=\"length\",u=\"\",c=[],s=8*r[a],h=n.h=n.h||[],l=n.k=n.k||[],_=l[a],p={},v=2;64>_;v++)if(!p[v]){for(e=0;313>e;e+=v)p[e]=v;h[_]=f(v,.5)*i|0,l[_++]=f(v,1/3)*i|0}for(r+=\"\\x80\";r[a]%64-56;)r+=\"\\x00\";for(e=0;e<r[a];e++){if(o=r.charCodeAt(e),o>>8)return;c[e>>2]|=o<<(3-e)%4*8}for(c[c[a]]=s/i|0,c[c[a]]=s,o=0;o<c[a];){var d=c.slice(o,o+=16),m=h;for(h=h.slice(0,8),e=0;64>e;e++){var g=d[e-15],y=d[e-2],C=h[0],M=h[4],S=h[7]+(t(M,6)^t(M,11)^t(M,25))+(M&h[5]^~M&h[6])+l[e]+(d[e]=16>e?d[e]:d[e-16]+(t(g,7)^t(g,18)^g>>>3)+d[e-7]+(t(y,17)^t(y,19)^y>>>10)|0),w=(t(C,2)^t(C,13)^t(C,22))+(C&h[1]^C&h[2]^h[1]&h[2]);h=[S+w|0].concat(h),h[4]=h[4]+S|0}for(e=0;8>e;e++)h[e]=h[e]+m[e]|0}for(e=0;8>e;e++)for(o=3;o+1;o--){var x=h[e]>>8*o&255;u+=(16>x?0:\"\")+x.toString(16)}return u};!function(n){function r(){for(var r,i=0;r=o[i];i++){var a=r[0];if(!a||e[a]){for(var u,c=r[1],s=r[2],h=[],l=0;l<c.length;l++)h[l]=f[u=c[l]],r=u in f&&r,e[u]||(i=e[u]=-1);r&&(o.splice(i,1),s=\"function\"==typeof s?s.apply(n,h):s,a&&(f[a]=s),i=-1)}}t._d&&t._d()}var t=(n.require=function(n,o){if(o){for(var f=0;f<n.length;f++)e[n[f]]=1;return t(0,n,o)}if(e[n]=1,r(),n in t._m)return t._m[n];throw n},n.define=function(n,e,f){f||(f=e,e=n||[],n=t._n||Math.random()),o.push([n,e,f]),r()}),e=t._r={},o=t._p=[],f=t._m={};t.amd={caution:\"0.5.0\"},t._c={_m:{},fail:function(n,r){alert(\"Missing safe module: \"+n+\"\\n\"+r.join(\"\\n\"))},urls:function(){return[]},_init:function(n,r,e){function o(a){if(i.length){var u=new XMLHttpRequest,c=i.shift();u.open(\"GET\",c),u.onreadystatechange=function(){if(u.readyState>3){for(var r,i=u.status/100^2,a=u.responseText.replace(/\\r/g,\"\"),s=i||sha256(encodeURI(a).replace(/%../g,function(n){return String.fromCharCode(\"0x\"+n[1]+n[2]-0)})),h=0;r=e.pop();)h|=eval(\"/^\"+r+\"/\").test(s);!i&&h?(t._n=n,f._m[n]=[c,s],Function(a)(),t._n=\"\"):o(1)}};try{u.send()}catch(s){o(s)}}else f.fail(n,r,a)}var f=this,i=f.urls(n,r);e=e||r,f._m[n]||(f._m[n]=[],o())}}}(this);";
